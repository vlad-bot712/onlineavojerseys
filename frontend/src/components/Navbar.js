...
import { ShoppingCart, Euro, User, Heart, Package, HelpCircle } from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link to="/" data-testid="logo-link" className="flex items-center">
              <div className="flex items-center" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
                ...
                <span className="text-3xl font-black text-[#CCFF00] ml-0.5 tracking-tighter">JERSEYS</span>
              </div>
            </Link>
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="flex items-center justify-center w-10 h-10 bg-[#CCFF00] text-black hover:bg-black hover:text-[#CCFF00] transition-all relative group"
                title="Cod Reducere"
              >
